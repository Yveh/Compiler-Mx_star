...
namespace atn {
  ...
  public:
    ...
    /// <embed antlr4_runtime="images/SingletonMerge_SameRootSamePar.svg" type="image/svg+xml"/>
    ///
    /// <p/>
    ///
    ...
    /// merged parents.<br/>
    /// <embed antlr4_runtime="images/SingletonMerge_SameRootDiffPar.svg" type="image/svg+xml"/>
    ///
    /// <p/>
    ///
    ...
    /// parent.<br/>
    /// <embed antlr4_runtime="images/SingletonMerge_DiffRootSamePar.svg" type="image/svg+xml"/>
    ///
    /// <p/>
    ///
    ...
    /// parent.<br/>
    /// <embed antlr4_runtime="images/SingletonMerge_DiffRootDiffPar.svg" type="image/svg+xml"/>
    /// </summary>
     ...
     * <embed antlr4_runtime="images/LocalMerge_EmptyRoot.svg" type="image/svg+xml"/></p>
     *
     * <p>{@link #EMPTY} and anything is {@code #EMPTY}, so merged parent is
     * {@code #EMPTY}; return left graph.<br>
     * <embed antlr4_runtime="images/LocalMerge_EmptyParent.svg" type="image/svg+xml"/></p>
     *
     * <p>Special case of last merge if local context.<br>
     * <embed antlr4_runtime="images/LocalMerge_DiffRoots.svg" type="image/svg+xml"/></p>
     *
     ...
     * is false.</p>
     *
     * <p><embed antlr4_runtime="images/FullMerge_EmptyRoots.svg" type="image/svg+xml"/></p>
     *
     * <p>Must keep all contexts; {@link #EMPTY} in array is a special value (and
     * null parent).<br>
     * <embed antlr4_runtime="images/FullMerge_EmptyRoot.svg" type="image/svg+xml"/></p>
     *
     * <p><embed antlr4_runtime="images/FullMerge_SameRoot.svg" type="image/svg+xml"/></p>
     *
     ...
     * <embed antlr4_runtime="images/ArrayMerge_DiffTopDiffPar.svg" type="image/svg+xml"/></p>
     *
     * <p>Shared top, same parents.<br>
     * <embed antlr4_runtime="images/ArrayMerge_ShareTopSamePar.svg" type="image/svg+xml"/></p>
     *
     * <p>Shared top, different parents.<br>
     * <embed antlr4_runtime="images/ArrayMerge_ShareTopDiffPar.svg" type="image/svg+xml"/></p>
     *
     * <p>Shared top, all shared parents.<br>
     * <embed antlr4_runtime="images/ArrayMerge_ShareTopSharePar.svg" type="image/svg+xml"/></p>
     *
     * <p>Equal tops, merge parents and reduce top to
     * {@link SingletonPredictionContext}.<br>
     * <embed antlr4_runtime="images/ArrayMerge_EqualTop.svg" type="image/svg+xml"/></p>
     */
