...
namespace atn {
  ...
  /// <summary>
  /// This class represents profiling event information for a syntax errors
  ...
  public:
    ...
    /// specified detailed syntax errors information.
    /// </summary>
    ...
    /// <param name="stopIndex"> The index at which the syntax errors was identified </param>
    /// <param name="fullCtx"> {@code true} if the syntax errors was identified during LL
    /// prediction; otherwise, {@code false} if the syntax errors was identified
