...
namespace antlr4 {
  ...
  ///  the errors handling strategy (to create missing tokens).  Notifying the parser
  ///  of a new factory means that it notifies it's token source and errors strategy.
  ...
  public:
    ...
    /// errors handling strategy. If text!=null, than the start and stop positions
